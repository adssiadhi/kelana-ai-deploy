...
function TripsDashboardContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans selection:bg-neutral-500 selection:text-white">
      {/* Navigation Bar */}
      <Navbar />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-neutral-950 to-slate-900 text-white clip-chamfer-lg p-6 sm:p-10 shadow-xl shadow-slate-200/80 border border-slate-800 mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-neutral-500/20 text-neutral-300 border border-neutral-400/30 mb-3">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={isLoading}
                className="p-3 clip-chamfer bg-white/10 hover:bg-white/20 text-slate-200 border border-white/15 transition-all cursor-pointer"
                title="Refresh trips"
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-5 py-3 clip-chamfer font-bold text-sm text-white bg-neutral-800 hover:bg-neutral-900 shadow-lg shadow-neutral-500/25 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-8 pt-6 border-t border-white/10">
            <div className="bg-white/5 backdrop-blur-md clip-chamfer p-4 border border-white/10">
              <div className="text-slate-400 text-xs font-medium flex items-center gap-1.5">
                <FolderOpen className="w-3.5 h-3.5 text-neutral-400" /> My Saved Trips
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-md clip-chamfer p-4 border border-white/10">
              <div className="text-slate-400 text-xs font-medium flex items-center gap-1.5">
                <MapPin className="w-3.5 h-3.5 text-neutral-400" /> Destinations
              </div>
              <div className="text-xl sm:text-2xl font-black text-white mt-1">
            ...
            <div className="bg-white/5 backdrop-blur-md clip-chamfer p-4 border border-white/10">
              <div className="text-slate-400 text-xs font-medium flex items-center gap-1.5">
                <Wallet className="w-3.5 h-3.5 text-neutral-400" /> Total Planned
              </div>
              <div className="text-xl sm:text-2xl font-black text-neutral-400 mt-1">
            ...
            <div className="bg-white/5 backdrop-blur-md clip-chamfer p-4 border border-white/10">
              <div className="text-slate-400 text-xs font-medium flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-neutral-400" /> Engine
              </div>
              <div className="text-xl sm:text-2xl font-black text-white mt-1">
                Bedrock AI
              </div>
        ...
        <div className="bg-white clip-chamfer border border-slate-200 p-4 sm:p-5 shadow-xs mb-8 space-y-4">
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 clip-chamfer-sm border border-slate-300 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:border-neutral-500 transition-all"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-2 self-end md:self-auto">
              ...
              <select
                ...
                className="py-2 px-3 clip-chamfer-sm border border-slate-300 text-xs sm:text-sm font-medium text-slate-800 bg-white focus:outline-none focus:ring-2 focus:ring-neutral-500 cursor-pointer"
              >
            ...
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              {(
                ...
                <button
                  ...
                  className={`px-3 py-1.5 clip-chamfer-sm font-semibold transition-all cursor-pointer ${
        ...
        {isLoading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-pulse">
            {[1, 2, 3, 4, 5, 6].map((idx) => (
              <div key={idx} className="bg-white clip-chamfer border border-slate-200 p-6 h-72 space-y-4">
                <div className="h-4 bg-slate-200 rounded-md w-1/3" />
                <div className="h-6 bg-slate-200 rounded-md w-3/4" />
                <div className="h-4 bg-slate-200 rounded-md w-1/2" />
                <div className="h-12 bg-slate-100 clip-chamfer-sm" />
                <div className="h-10 bg-slate-200 clip-chamfer-sm" />
              </div>
            ))}
          </div>
        )}
        ...
        {/* Error State */}
        {error && !isLoading && (
          <div className="bg-neutral-100 border border-neutral-200 clip-chamfer p-6 sm:p-8 text-center max-w-xl mx-auto my-12">
            <div className="w-12 h-12 rounded-full bg-neutral-200 text-neutral-600 flex items-center justify-center mx-auto mb-3 font-bold text-xl">
              !
            </div>
            <h3 className="text-lg font-bold text-neutral-900 mb-2">Unable to Load Trips</h3>
            <p className="text-xs sm:text-sm text-neutral-700 mb-5 leading-relaxed">{error}</p>
            <button
              onClick={fetchTripList}
              className="inline-flex items-center gap-2 px-5 py-2.5 clip-chamfer-sm bg-neutral-800 hover:bg-neutral-900 text-white font-bold text-xs shadow-sm transition-all cursor-pointer"
            >
        ...
        {!isLoading && !error && trips.length === 0 && (
          <div className="bg-white clip-chamfer-lg border border-slate-200 p-10 sm:p-16 text-center max-w-2xl mx-auto shadow-sm my-8">
            <div className="w-20 h-20 clip-chamfer-lg bg-neutral-100 text-neutral-600 flex items-center justify-center mx-auto mb-5 shadow-inner select-none">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3.5 clip-chamfer font-bold text-white bg-neutral-800 hover:bg-neutral-900 shadow-lg shadow-neutral-600/25 transition-all hover:scale-105"
            >
        ...
        {!isLoading && !error && trips.length > 0 && filteredAndSortedTrips.length === 0 && (
          <div className="bg-white clip-chamfer border border-slate-200 p-10 text-center max-w-lg mx-auto my-8">
            <div className="text-3xl mb-3"><Search className="w-8 h-8 text-slate-400 mx-auto" /></div>
            ...
            <button
              ...
              className="px-4 py-2 clip-chamfer-sm bg-neutral-100 hover:bg-neutral-200 text-neutral-800 font-semibold text-xs transition-colors cursor-pointer"
            >
              Reset Filters
            </button>
          </div>
